-- Run in Supabase SQL Editor for editable referral program in admin
...
DROP POLICY IF EXISTS referral_program_read ON referral_program_settings;
CREATE POLICY referral_program_read ON referral_program_settings FOR SELECT USING (true);

DROP POLICY IF EXISTS referral_program_admin ON referral_program_settings;
